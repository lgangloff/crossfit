...
class MemberGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Member entity")
        ...
        .repeat(2) {
            ...
            .post("/api/members")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "telephonNumber":"SAMPLE_TEXT", "sickNoteEndDate":"2020-01-01T00:00:00.000Z", "membershipStartDate":"2020-01-01T00:00:00.000Z", "membershipEndDate":"2020-01-01T00:00:00.000Z", "level":null}""")).asJSON
            .check(status.is(201))
            .check(headerRegex("Location", "(.*)").saveAs("new_member_url")))
            .pause(10)
            .repeat(5) {
